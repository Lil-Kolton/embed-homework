...
namespace OHOS {
static constexpr uint16_t IMAGE_ANIMATOR_TIME_S = 10000; // Cyclic image playback interval
static constexpr uint8_t IMAGE_TOTEL_NUM = 5;      // Number of images

static const char* const IMG_DEFAULT_001_PATH =
    "/storage/app/run/com.huawei.screensaver/screensaver/assets/screensaver/resources/base/media/spring.png";
static const char* const IMG_DEFAULT_002_PATH =
    "/storage/app/run/com.huawei.screensaver/screensaver/assets/screensaver/resources/base/media/summer.png";
static const char* const IMG_DEFAULT_003_PATH =
    "/storage/app/run/com.huawei.screensaver/screensaver/assets/screensaver/resources/base/media/autumn.png";
static const char* const IMG_DEFAULT_004_PATH =
    "/storage/app/run/com.huawei.screensaver/screensaver/assets/screensaver/resources/base/media/winter.png";
static const char* const IMG_DEFAULT_005_PATH =
    "/storage/app/run/com.huawei.screensaver/screensaver/assets/screensaver/resources/base/media/bearpi.png";
