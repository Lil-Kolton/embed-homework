...
namespace OHOS {
    static int16_t ROOTVIEW_W = 800; // launcher table width
    ...
    #define RES_AIR_LUX             "/storage/app/run/com.huawei.cenctrl/cenctrl/res/airLux.png"
    #define RES_AIR_TEMP             "/storage/app/run/com.huawei.cenctrl/cenctrl/res/airTemp.png"
    ...
    #define RES_AIR_COND_SELECT      "/storage/app/run/com.huawei.cenctrl/cenctrl/res/air_condition_on.png"
    #define RES_AIR_COND_UNSELECT    "/storage/app/run/com.huawei.cenctrl/cenctrl/res/air_condition_off.png"
